    ...
    <body>
        ...
        <div id="container" class="page-content">
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">O conjunto de dados está em inglês?</h4>
                <h3 id="q1"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>

            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">A identificação do conjunto de dados segue o padrão Nome do produto_tecnologia_outra especificação?</h4>
                <h3 id="q2"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">As citações e referências estão completas?</h4>
                <h3 id="q3"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Os campos de administração são informados?</h4>
                <h3 id="q4"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">É informada a cobertura temporal do conjunto de dados?</h4>
                <h3 id="q5"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">A cobertura tecnológica é informada?</h4>
                <h3 id="q7"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">A descrição da tecnologia é apresentada?</h4>
                <h3 id="q8"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">A cobertura geográfica é informada?</h4>
                <h3 id="q9"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">É informada a representatividade do conjunto de dados?</h4>
                <h3 id="q10"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Foi aplicado critério de corte? Se sim, qual foi o critério utilizado?</h4>
                <h3 id="q12"></h3>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Houve agregação dos dados? Qual o nível de agregação utilizado?</h4>
                <h3 id="q13"></h3>
                <span class="caption">Qual?</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">As conexões dos fluxos intermediários com os processos elementares secundários foram apresentadas?</h4>
                <h3 id="q15"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Foi considerado o uso da terra (ocupação e transformação)?</h4>
                <h3 id="q17"></h3>
                <span class="caption">Qual foi o método utilizado para transformação do uso da terra?</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                ...
                <h3 id="q18"></h3>
                <span class="caption">Qual foi o método utilizado?</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>

            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Se o balanço de massa foi realizado, quanto foi fechado nos processos elementares primários?</h4>
                <h3 id="q19"></h3>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Se o balanço de água foi realizado, quanto foi fechado nos processos elementares primários?</h4>
                <h3 id="q20"></h3>
                <span class="caption">Quanto? (0 a 100%)</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Se o balanço de energia foi realizado, quanto foi fechado nos processos elementares primários?</h4>
                <h3 id="q21"></h3>
                <span class="caption">Quanto? (0 a 100%)</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Foi adotado algum método para analisar a qualidade dos dados?</h4>
                <h3 id="q22"></h3>
                <span class="caption">Qual?</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Os bens de capital foram incluídos?</h4>
                <h3 id="q23"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">A identificação dos fluxos seguiu o padrão definido no Guia? Em caso negativo, adequar.</h4>
                <h3 id="q24"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">O fluxo de referência foi informado?</h4>
                <h3 id="q25"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">As unidades estão no Sistema Internacional (SI)?</h4>
                <h3 id="q26"></h3>
                <span class="caption">Se não, descrever as possíveis relações com as unidades do SI.</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>

            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Cada fluxo tecnológico está especificado por região?</h4>
                <h3 id="q27"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">São informados os compartimentos e subcompartimentos?</h4>
                <h3 id="q28"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">As emissões diretas de CO2 de MUT foram incluídas e discriminadas?</h4>
                <h3 id="q36"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Foram incluídos os dados do transporte?</h4>
                <h3 id="q37"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Caso tenha havido revisão crítica de terceira parte, as informações necessárias foram fornecidas?</h4>
                <h3 id="q41"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
            ...
            <div class="row" style="margin-left:10px;">
                <h4 class="text-light" style="margin-right: 20px;">Se houve revisão crítica, o relatório da revisão pode ser disponibilizado para os revisores do SICV, junto com o conjunto de dados?</h4>
                <h3 id="q42"></h3>
                <span class="caption">Comentário</span>
                <br /><div class="input-control textarea"><textarea disabled=""></textarea></div>
            </div>
        ...
        <div data-role="dialog" id="dialog" class="padding20" data-close-button="true" data-windows-style="true" data-overlay="true" data-overlay-color="op-dark" data-overlay-click-close="true">
            <div class="container">
                <h1>Aprovar</h1>
                <p>
                    Você tem certeza que deseja aprovar a revisão de qualidade ?
                </p>
                <p>
        ...
        <div data-role="dialog" id="dialog2" class="padding20" data-close-button="true" data-windows-style="true" data-overlay="true" data-overlay-color="op-dark" data-overlay-click-close="true">
            <div class="container">
                <h1>Reprovar</h1>
                <p>
                    Você tem certeza que deseja reprovar a revisão de qualidade ?
                </p>
                <p>
