...
<body>
<p>
Prezado Administrador de qualidade do Banco Nacional de Inventários do Ciclo de Vida,<br/>
Informamos que o inventário ${ilcdTitle} foi importado com sucesso para a base ${urlTrack} na data ${date}. Ele aguarda agora sua análise e qualificação.
</p>
<p>
