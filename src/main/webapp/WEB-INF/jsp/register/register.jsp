    ...
    <body>
        ...
        <div class="register-form">
            ...
            <form method="post" action="<%=Strings.BASE%>/register" >
                ...
                <div class="row">
                    <div class="col s12">
                        <b style="color: #00697C;font-size: 20px">CADASTRO </b> <div class="show-on-medium"><br /></div>
                        <a href="<%=Strings.BASE%>/" style="white-space: nowrap;color: #00697C;font-size: 20px;"><span class="hide-on-small-only">| </span>Já possuo cadastro</a>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m5" style="margin-top: -8px;">
