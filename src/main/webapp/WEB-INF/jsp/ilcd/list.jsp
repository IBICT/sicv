...
<html>
    <head>
        ...
        <link href="./assets/metro-ui3.0.17/css/metro.css" rel="stylesheet">
        <link href="./assets/metro-ui3.0.17/css/metro-icons.css" rel="stylesheet">
        <link href="./assets/metro-ui3.0.17/css/metro-responsive.css" rel="stylesheet">

        <script src="./assets/metro-ui3.0.17/js/jquery-2.1.3.min.js"></script>
        <script src="./assets/metro-ui3.0.17/js/jquery.dataTables.min.js"></script>
