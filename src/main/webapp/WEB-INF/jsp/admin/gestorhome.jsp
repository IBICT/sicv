...
<body>
    ...
    <div class="sicv-container sicv-inventori-table">
        ...
        <div style="margin:0px;" class="row">
            <div style="height: 40px; position: relative; top: 10px;" class="col s3 sicv-table-td">${ilcdId }266c5da8-55bc-4d58-a4af-cbf7724f7939</div>
            <div style="height: 40px; position: relative; top: 10px;" class="col s3 sicv-table-td">${ilcdName}Phenol from cumene production mix, at producer</div>
                ...
                <form class="col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <button class="btn-import waves-effect waves-light btn">Acrescentar autor</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                    ...
                    <div class="row">
                        <h5>Submissão Inventário</h5>
                    </div>
                    <div class="row">
                        <h5 class="page-title">Conflitos de interesses</h5>
                    </div>
                    <div class="row">
